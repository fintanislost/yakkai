...
constexpr std::string_view WE_REFLECTION_BUFFER { "_rt_Reflection" };
...
constexpr std::string_view G_EYE { "g_EyePosition" };
constexpr std::string_view G_NML { "g_NormalModelMatrix" };
...
constexpr std::string_view G_LAC { "g_LightAmbientColor" };
constexpr std::string_view G_LSC { "g_LightSkylightColor" };
