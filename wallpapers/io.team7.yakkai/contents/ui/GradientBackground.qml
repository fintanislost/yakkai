...
Item {
    ...
    property color manualStartColor: "#0b1f33"
    property color manualEndColor: "#4d7cff"
    property int baseAngle: 125
    property bool animate: true
    property int animationDuration: 30
    property int driftDegrees: 10
    property int vignetteStrength: 18
    property bool useTimeOfDay: false
    property int dayStartHour: 7
    property int nightStartHour: 19
    property int transitionMinutes: 60
    property color dayStartColor: "#87b8ff"
    property color dayEndColor: "#f6d365"
    property color nightStartColor: "#0b1f33"
    property color nightEndColor: "#4d7cff"
